...
[Note: I merged the training data and test data to create one csv file to use in the report]

Follow the instructions and comments within the notebook to understand and execute each part of the script.
